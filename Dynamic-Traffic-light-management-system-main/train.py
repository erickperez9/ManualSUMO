...
def run(train=True,model_name="model",epochs=50,steps=500,ard=False):
    ...
    for e in range(epochs):
        if train:
            ...
            traci.start(
            [checkBinary("sumo-gui"), "-c", "configuration.sumocfg", "--tripinfo-output", "tripinfo-trained.xml"]
            )
        ...
        while step <= steps:
            ...
            for junction_number, junction in enumerate(all_junctions):
                ...
                # print("traffic_lights_time: " , traffic_lights_time)
                ...
                if traffic_lights_time[junction] == 0:
                    ...
                    # print(f"state juntion {junction} changed")
        ...
        print(f"total_time epoch {e}: ",total_time)
