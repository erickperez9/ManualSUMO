# -*- coding: utf-8 -*-
"""
Created on Mon Feb 26 17:43:05 2024
...
def data_set(archivo_entrada): 
    ...
    # Eliminar las filas que contienen 0 en la segunda columna, excepto aquellas con un 3 en la tercera columna
    # df_filtrado = df_filtrado[(df_filtrado.iloc[:, 1] != 0) | (df_filtrado.iloc[:, 2] == 3)]
